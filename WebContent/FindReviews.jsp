...
<table border="1">
    ...
    <c:forEach items="${reviews}" var="reviews" >
        <tr>
            ...
            <td><a href="deletereviews?reviewid=<c:out value="${reviews.getReviewsid()}"/>">Delete</a></td>
            <td><a href="updatereviews?reviewid=<c:out value="${reviews.getReviewsid()}"/>">Update</a></td>
        </tr>
    </c:forEach>
</table>
</body>
