...
<form action="findmovies" method="post">
    <h4 style="text-align: center">Here are your list of Recommended Movies <c:out value="${username}" /> </h4>
...
<table border="1">
    ...
    <c:forEach items="${userRecommendedMovies}" var="userRecommendedMovies" >
        <tr>
            <td><c:out value="${userRecommendedMovies.getMoviesId()}" /></td>
            <td><c:out value="${userRecommendedMovies.getMoviename()}" /></td>
            <td><c:out value="${userRecommendedMovies.getOverview()}" /></td>
            <td><c:out value="${userRecommendedMovies.getReleasedate()}" /></td>
            <td><c:out value="${userRecommendedMovies.getCountry()}" /></td>
            <td><c:out value="${userRecommendedMovies.getLanguage()}" /></td>
            <td><c:out value="${userRecommendedMovies.getGenre()}" /></td>
            <td><c:out value="${userRecommendedMovies.getRuntime()}" /></td>
            <td><c:out value="${userRecommendedMovies.getAvg_rating()}" /></td>
            <%--<td><a href="deletemovies?movieid=<c:out value="${userRecommendedMovies.getMoviesId()}"/>">Delete</a></td>--%>
            <%--<td><a href="updatemovie?movieid=<c:out value="${userRecommendedMovies.getMoviesId()}"/>">Update</a></td>--%>
        </tr>
    </c:forEach>
</table>
</body>
